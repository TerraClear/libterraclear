...
${OBJECTDIR}/_ext/b9c8e08b/camera_velocity_calculator.o: /home/izzy/TerraClear/yolo-detect/libterraclear/src/camera_velocity_calculator.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g `pkg-config --cflags opencv` -std=c++11  -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/b9c8e08b/camera_velocity_calculator.o /home/izzy/TerraClear/yolo-detect/libterraclear/src/camera_velocity_calculator.cpp

${OBJECTDIR}/_ext/b9c8e08b/velocity_calculator.o: /home/izzy/TerraClear/yolo-detect/libterraclear/src/velocity_calculator.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/b9c8e08b
	${RM} "$@.d"
	$(COMPILE.cc) -g `pkg-config --cflags opencv` -std=c++11  -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/b9c8e08b/velocity_calculator.o /home/izzy/TerraClear/yolo-detect/libterraclear/src/velocity_calculator.cpp

${OBJECTDIR}/_ext/b9c8e08b/velocity_tracker.o: /home/izzy/TerraClear/yolo-detect/libterraclear/src/velocity_tracker.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/b9c8e08b
	${RM} "$@.d"
	$(COMPILE.cc) -g `pkg-config --cflags opencv` -std=c++11  -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/b9c8e08b/velocity_tracker.o /home/izzy/TerraClear/yolo-detect/libterraclear/src/velocity_tracker.cpp
...
${OBJECTDIR}/src/appsettings.o: src/appsettings.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/data/sources `pkg-config --cflags opencv` -std=c++11  -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/appsettings.o src/appsettings.cpp

${OBJECTDIR}/src/basicserial.o: src/basicserial.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/data/sources `pkg-config --cflags opencv` -std=c++11  -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/basicserial.o src/basicserial.cpp

${OBJECTDIR}/src/camera_base.o: src/camera_base.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/data/sources `pkg-config --cflags opencv` -std=c++11  -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/camera_base.o src/camera_base.cpp

${OBJECTDIR}/src/camera_depth.o: src/camera_depth.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/data/sources `pkg-config --cflags opencv` -std=c++11  -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/camera_depth.o src/camera_depth.cpp

${OBJECTDIR}/src/camera_depth_realsense.o: src/camera_depth_realsense.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/data/sources `pkg-config --cflags opencv` -std=c++11  -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/camera_depth_realsense.o src/camera_depth_realsense.cpp

${OBJECTDIR}/src/camera_depth_zed.o: src/camera_depth_zed.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/data/sources `pkg-config --cflags opencv` -std=c++11  -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/camera_depth_zed.o src/camera_depth_zed.cpp

${OBJECTDIR}/src/camera_file.o: src/camera_file.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/data/sources `pkg-config --cflags opencv` -std=c++11  -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/camera_file.o src/camera_file.cpp

${OBJECTDIR}/src/camera_flir_blackfly.o: src/camera_flir_blackfly.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/data/sources `pkg-config --cflags opencv` -std=c++11  -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/camera_flir_blackfly.o src/camera_flir_blackfly.cpp

${OBJECTDIR}/src/camera_flir_blackfly_system.o: src/camera_flir_blackfly_system.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/data/sources `pkg-config --cflags opencv` -std=c++11  -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/camera_flir_blackfly_system.o src/camera_flir_blackfly_system.cpp

${OBJECTDIR}/src/camera_lucid_triton.o: src/camera_lucid_triton.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/data/sources `pkg-config --cflags opencv` -std=c++11  -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/camera_lucid_triton.o src/camera_lucid_triton.cpp

${OBJECTDIR}/src/camera_recorder.o: src/camera_recorder.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/data/sources `pkg-config --cflags opencv` -std=c++11  -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/camera_recorder.o src/camera_recorder.cpp
...
${OBJECTDIR}/src/detector_base.o: src/detector_base.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/data/sources `pkg-config --cflags opencv` -std=c++11  -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/detector_base.o src/detector_base.cpp

${OBJECTDIR}/src/detector_hsv.o: src/detector_hsv.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/data/sources `pkg-config --cflags opencv` -std=c++11  -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/detector_hsv.o src/detector_hsv.cpp

${OBJECTDIR}/src/detector_motion.o: src/detector_motion.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/data/sources `pkg-config --cflags opencv` -std=c++11  -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/detector_motion.o src/detector_motion.cpp

${OBJECTDIR}/src/error_base.o: src/error_base.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/data/sources `pkg-config --cflags opencv` -std=c++11  -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/error_base.o src/error_base.cpp

${OBJECTDIR}/src/filetools.o: src/filetools.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/data/sources `pkg-config --cflags opencv` -std=c++11  -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/filetools.o src/filetools.cpp
...
${OBJECTDIR}/src/msgserver.o: src/msgserver.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/data/sources `pkg-config --cflags opencv` -std=c++11  -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/msgserver.o src/msgserver.cpp

${OBJECTDIR}/src/navmath.o: src/navmath.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/data/sources `pkg-config --cflags opencv` -std=c++11  -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/navmath.o src/navmath.cpp

${OBJECTDIR}/src/stopwatch.o: src/stopwatch.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/data/sources `pkg-config --cflags opencv` -std=c++11  -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/stopwatch.o src/stopwatch.cpp
...
${OBJECTDIR}/src/vision_warp.o: src/vision_warp.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/data/sources `pkg-config --cflags opencv` -std=c++11  -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/vision_warp.o src/vision_warp.cpp
