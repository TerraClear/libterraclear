...
${OBJECTDIR}/_ext/cc787d41/vision_core.o: /home/koos/Desktop/Dropbox/Private/Code/cpp/libterraclear/src/vision_core.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/cc787d41
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/cc787d41/vision_core.o /home/koos/Desktop/Dropbox/Private/Code/cpp/libterraclear/src/vision_core.cpp
...
${OBJECTDIR}/src/chessboard_calib.o: src/chessboard_calib.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/chessboard_calib.o src/chessboard_calib.cpp
...
${OBJECTDIR}/src/light_meter_camera_calibrator.o: src/light_meter_camera_calibrator.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/light_meter_camera_calibrator.o src/light_meter_camera_calibrator.cpp
...
${OBJECTDIR}/src/vision_filtering.o: src/vision_filtering.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/vision_filtering.o src/vision_filtering.cpp
