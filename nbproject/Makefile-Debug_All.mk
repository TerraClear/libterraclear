...
${OBJECTDIR}/_ext/b9c8e08b/velocity_calculator.o: /home/izzy/TerraClear/yolo-detect/libterraclear/src/velocity_calculator.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/b9c8e08b
	${RM} "$@.d"
	$(COMPILE.cc) -g `pkg-config --cflags libserialport` `pkg-config --cflags realsense2` `pkg-config --cflags opencv` -std=c++11  -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/b9c8e08b/velocity_calculator.o /home/izzy/TerraClear/yolo-detect/libterraclear/src/velocity_calculator.cpp

${OBJECTDIR}/_ext/b9c8e08b/velocity_tracker.o: /home/izzy/TerraClear/yolo-detect/libterraclear/src/velocity_tracker.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/b9c8e08b
	${RM} "$@.d"
	$(COMPILE.cc) -g `pkg-config --cflags libserialport` `pkg-config --cflags realsense2` `pkg-config --cflags opencv` -std=c++11  -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/b9c8e08b/velocity_tracker.o /home/izzy/TerraClear/yolo-detect/libterraclear/src/velocity_tracker.cpp
