...
${OBJECTDIR}/_ext/b9c8e08b/camera_velocity_calculator.o: /home/izzy/TerraClear/yolo-detect/libterraclear/src/camera_velocity_calculator.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g `pkg-config --cflags libserialport` `pkg-config --cflags realsense2` `pkg-config --cflags opencv` -std=c++11  -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/b9c8e08b/camera_velocity_calculator.o /home/izzy/TerraClear/yolo-detect/libterraclear/src/camera_velocity_calculator.cpp
...
${OBJECTDIR}/_ext/b9c8e08b/rock_distance_tracker.o: /home/izzy/TerraClear/yolo-detect/libterraclear/src/rock_distance_tracker.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/b9c8e08b
	${RM} "$@.d"
	$(COMPILE.cc) -g `pkg-config --cflags libserialport` `pkg-config --cflags realsense2` `pkg-config --cflags opencv` -std=c++11  -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/b9c8e08b/rock_distance_tracker.o /home/izzy/TerraClear/yolo-detect/libterraclear/src/rock_distance_tracker.cpp
...
${OBJECTDIR}/src/velocity_calculator.o: src/velocity_calculator.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g `pkg-config --cflags libserialport` `pkg-config --cflags realsense2` `pkg-config --cflags opencv` -std=c++11  -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/velocity_calculator.o src/velocity_calculator.cpp

${OBJECTDIR}/src/velocity_tracker.o: src/velocity_tracker.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g `pkg-config --cflags libserialport` `pkg-config --cflags realsense2` `pkg-config --cflags opencv` -std=c++11  -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/velocity_tracker.o src/velocity_tracker.cpp

${OBJECTDIR}/src/vision_warp.o: src/vision_warp.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g `pkg-config --cflags libserialport` `pkg-config --cflags realsense2` `pkg-config --cflags opencv` -std=c++11  -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/vision_warp.o src/vision_warp.cpp
